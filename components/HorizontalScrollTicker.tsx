...
export function HorizontalScrollTicker() {
  ...
  useEffect(() => {
    ...
    // Calculate how far to scroll. We want to move the text container
    // completely across the screen.
    const getScrollAmount = () => {
      const textWidth = textRef.current?.scrollWidth || 0;
      return -(textWidth - window.innerWidth + 100); // 100px padding
    };
    ...
    const tl = gsap.to(textRef.current, {
      ...
      scrollTrigger: {
        ...
        scrub: 1,
        pin: false, // We won't pin it, just scroll as it's in view
      },
    });
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative w-full h-[150vh] bg-[#050505] flex items-center overflow-hidden border-y border-[#1a1a1a]"
    >
      <div className="sticky top-1/2 -translate-y-1/2 w-full flex overflow-hidden whitespace-nowrap px-10">
